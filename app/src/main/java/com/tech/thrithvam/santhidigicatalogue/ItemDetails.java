...
import static com.tech.thrithvam.santhidigicatalogue.User.FROM_D;
...
//    String descriptionString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String getrec=description.getText().toString();
...
//        price = (TextView) findViewById(R.id.price);
        ...
        Button enquiry=(Button)findViewById(R.id.buyNow);
        enquiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentEnquiry = new Intent(ItemDetails.this, EnquiryItem.class);
                intentEnquiry.putExtra("productName", productName);
                intentEnquiry.putExtra("productID", productID);
                intentEnquiry.putExtra("userID",db.GetUserDetail("UserID"));
                intentEnquiry.putExtra("productNo", String.valueOf(productNoInt));
                intentEnquiry.putExtra("boutiqueID",constants.BoutiqueID);

                intentEnquiry.putExtra("Description",descriptionString );
...
//                        }
                        if (categoryList.get(position).equals(getResources().getString(R.string.boutique_details))) {
                            Intent boutiqueIntent = new Intent(ItemDetails.this, BoutiqueDetails.class);
...
//          Button enquiry=(Button)findViewById(R.id.enquiry);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.user:
                ...
                intentUser.putExtra(KEY_EXTRA,FROM_D);
                startActivity(intentUser);
                overridePendingTransition(R.anim.slide_entry1,R.anim.slide_entry2);
                break;
//            case R.id.cart:
       ...
       /*     if(db.GetProductDetail(productID,"ProductID")!=null){
        ...
        protected void onPostExecute(Void result) {
            ...
            if(!pass) {
                ...
                description.setText(descriptionString);
                productNo.setText(getResources().getString(R.string.product_no, productNoInt));
                productNameView.setText(getResources().getString(R.string.p_number, productName));
...
//                                                shareIntent.putExtra(Intent.EXTRA_TEXT,descriptionString+"\t@\t"+constants.BoutiqueName);
    ...
    //=========================================>Add cart and buy now buttons work here
